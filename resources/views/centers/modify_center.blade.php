...
<div class="employees-list p-2 rounded bg-white">
    ...
    @if (session()->has("status"))
        ...
        @endif
    @endif
    <form action="{{route('centers.update_center',['id'=>Crypt::encryptString($center->id)])}}" method="POST" id="centersForm">
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="center" name="center" class="form-control @error('center') is-invalid @enderror " placeholder="Center Name" value="{{ old('center')?old('center'):$center->centername }}" autofocus="on" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="hra_perc" name="hra_perc" class="form-control @error('hra_perc') is-invalid @enderror " placeholder="HRA %" value="{{ old('hra_perc')?old('hra_perc'):$center->hra }}" required>
