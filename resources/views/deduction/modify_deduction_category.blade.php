...
<div class="employees-list p-2 rounded bg-white">
    <div class="d-flex justify-content-between align-items-center p-2 rounded">
        <h4 class="m-0">Modify Deduction</h4>
    ...
    @endif
    @endif
    <form action="{{route('deduction.update_deduction_category',['id'=>Crypt::encryptString($category->id)])}}" method="POST" id="deductionCategoryForm">
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="deduction_name" name="deduction_name" class="form-control @error('deduction_name') is-invalid @enderror" placeholder="Deduction Name" value="{{ (old('deduction_name'))?old('deduction_name'):$category->deduction_name }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="deduction_type_name" name="deduction_type_name" class="form-control @error('deduction_type_name') is-invalid @enderror" placeholder="Allowance Type Name" value="{{ old('deduction_type_name')?old('deduction_type_name') :$category->deduction_type_name  }}" required>
