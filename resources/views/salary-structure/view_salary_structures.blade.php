...
<div class="employees-list shadow-md p-2 rounded bg-white">
    <div class="d-flex justify-content-between align-items-center p-2 rounded">
        ...
        <div>
            ...
            <a href="{{route('salary-structure.modify_salary_structure',['id'=>Crypt::encryptString($structure->id)])}}" class="btn btn-info btn-sm rounded" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="mdi mdi-pencil"></i></a>
        </div>
    </div>
        ...
        <table class="table table-bordered mt-4" id="employeesTable">
            <tbody>
                <tr>
                    ...
                    <tr>
                        <th class="text-left">HRA Allowance({{$structure->hra_perc}}%)</th>
                        <td class="text-center">{{number_format($structure->hra)}}</td>
                    </tr>
                    <tr>
                        <th class="text-left">Transport Allowance</th>
                ...
                <tr>
                    ...
                    <tr>
                        <th class="text-left">NPS-Employee</th>
