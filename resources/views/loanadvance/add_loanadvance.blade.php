...
<div class="employees-list p-2 rounded bg-white">
    <div class="d-flex justify-content-between align-items-center p-2 rounded">
        <h4 class="m-0">Add Loan/Advance</h4>
    ...
    @if (session()->has("status"))
        ...
        @endif
    @endif
    <form action="{{route("loanadvance.store_loanadvance")}}" method="POST" id="attendanceForm">
        @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group da">
                        ...
                        <select name="la" id="la" class="form-control lea" required>
                            ...
                            <option value="loan" @if(old('la')=='loan') selected @endif>Loan</option>
                            <option value="advance" @if(old('la')=='advance') selected @endif>Advance</option>                           
                        </select>
                ...
                <div class="col-md-4 ded">
                    <div class="form-group">
                        ...
                        <select id="ded" name="ded" class="form-control da_types">
                            <option value="">---Select Deduction ---</option>
                             @foreach ($deduction as $ded)                            
                                <option value="{{ $ded->deduction_type_name }}" @if(old('deduction_type_name')==$ded->deduction_type_name) selected @endif>{{ $ded->deduction_name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4 alw">
                    <div class="form-group">
                        ...
                        <select id="alw" name="alw" class="form-control da_types">
                            <option value="">Advance</option>
                             @foreach ($allowance as $alw)                            
                                <option value="{{ $alw->allowance_type_name }}" @if(old('allowance_type_name')==$alw->allowance_type_name) selected @endif>{{ $alw->allowance_name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="tamt">Total Amount:<span class="text-danger">*</span></label>
                        <input type="number" class="form-control" id="tamt" name="tamt" placeholder="Total Amount" value="{{ old('tamt') }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="tenure" name="tenure" placeholder="Tenure (Only Month)" value="{{ old('tenure') }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="amt" name="amt" placeholder="Amount" value="{{ old('amt') }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="adj_instal_no" name="adj_instal_no" placeholder="Adj. Instal. No" value="{{ old('adj_instal_no') }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="adj_instal_amt" name="adj_instal_amt" placeholder="Adj. Instal. Amt" value="{{ old('adj_instal_amt') }}" required>
