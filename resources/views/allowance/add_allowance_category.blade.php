...
<div class="employees-list p-2 rounded bg-white">
    ...
    @endif
    @endif
    <form action="{{route('allowance.add_allowance_category')}}" method="POST" id="allowanceCategoryForm">
        @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="allowance_name" name="allowance_name" class="form-control @error('allowance_name') is-invalid @enderror" placeholder="Allowance Name" value="{{ old('allowance_name') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="allowance_type_name" name="allowance_type_name" class="form-control @error('allowance_type_name') is-invalid @enderror" placeholder="Allowance Type Name" value="{{ old('allowance_type_name') }}" required>
