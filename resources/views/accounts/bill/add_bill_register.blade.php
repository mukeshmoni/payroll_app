...
<div class="br-list p-2 rounded bg-white">
    <div class="d-flex justify-content-between align-items-center p-2 rounded">
        <h4 class="m-0">Create Bill Register</h4>
    ...
    @endif
    @endif
    <form action="{{route('br.add_bill_register')}}" method="POST" id="billRegisterForm">
        @csrf
        <div class="section-1-form section-forms">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" id="bill_date" name="bill_date" class="form-control @error('bill_date') is-invalid @enderror" placeholder="Bill Date" value="{{ old('bill_date') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="particulars" name="particulars" class="form-control @error('particulars') is-invalid @enderror" placeholder="Particulars" value="{{ old('particulars') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="amount" name="amount" class="form-control @error('amount') is-invalid @enderror" placeholder="Amount" value="{{ old('amount') }}" required>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name_of_clerk" name="name_of_clerk" class="form-control @error('name_of_clerk') is-invalid @enderror" placeholder="Name of Clerk" value="{{ old('name_of_clerk') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="received_from" name="received_from" class="form-control @error('received_from') is-invalid @enderror" placeholder="Received From" value="{{ old('received_from') }}" required>
            ...
            <div class="text-right">
                <button class="btn btn-primary saveNext" id="brSubmitForm" type="button">Add</button>
            </div>
        </div>
    </form>
