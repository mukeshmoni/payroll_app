...
<div class="employees-list p-2 rounded bg-white">
    ...
    <form action="{{route('employees.add_employee')}}" method="POST" id="EmployeeForm" autocomplete>
        @csrf
        <div class="section-1-form section-forms">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('empname') }}" id="empname" name="empname" class="form-control @error('empname') is-invalid @enderror" placeholder="Employee Name" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('fathername') }}" id="fathername" name="fathername" class="form-control @error('fathername') is-invalid @enderror" placeholder="Father's Name" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('mothername') }}" id="mothername" name="mothername" class="form-control @error('mothername') is-invalid @enderror" placeholder="Mother's Name" >
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{ old('empdob') }}" id="empdob" name="empdob" class="form-control @error('empdob') is-invalid @enderror" placeholder="Date of Birth" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="empgender" id="empgender" class="form-control @error('empgender') is-invalid @enderror" >
                            ...
                            <option value="male" {{old('empgender')=='male'?'selected':''}}>Male</option>
                            <option value="female" {{old('empgender')=='female'?'selected':''}}>Female</option>
                            <option value="transgender {{old('empgender')=='transgender'?'selected':''}}">Transgender</option>
                            <option value="not" {{old('empgender')=='not'?'selected':''}}>Prefer not to answer</option>
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" value="{{old('empcontact')}}" id="empcontact" name="empcontact" class="form-control @error('empcontact') is-invalid @enderror" placeholder="Contact Number" >
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('emppanno')}}" id="emppanno" name="emppanno" class="form-control @error('emppanno') is-invalid @enderror" placeholder="PAN Number" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('empaadhaarno')}}" id="empaadhaarno" name="empaadhaarno" class="form-control @error('empaadhaarno') is-invalid @enderror" placeholder="Aadhaar Number" >
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" value="{{old('empemail')}}" id="empemail" name="empemail" class="form-control @error('empemail') is-invalid @enderror" placeholder="Email">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="address" value="{{old('empaddress')}}" id="empaddress" name="empaddress" class="form-control @error('empaddress') is-invalid @enderror" placeholder="Address" >
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="empstate" id="empstate" class="form-control @error('empstate') is-invalid @enderror">
                            ...
                            @foreach($states as $state)
                                <option value="{{$state->id}}" {{old('empstate')==$state->id?'selected':''}}>{{$state->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('pincode')}}" id="pincode" name="pincode" class="form-control @error('pincode') is-invalid @enderror" placeholder="Pincode" >
            ...
            <div class="text-right">
                <button class="btn btn-outline-dark saveBtn mr-2" type="button">Save</button>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('empid')}}" id="empid" name="empid" class="form-control @error('empid') is-invalid @enderror" placeholder="Employee ID" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{old('empdoj')}}" id="empdoj" name="empdoj" class="form-control @error('empdoj') is-invalid @enderror" placeholder="Date of Joining" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" id="empdor" name="empdor" value="{{old('empdor')}}" class="form-control" placeholder="Date of Retirement">
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="designation" id="designation" class="form-control @error('designation') is-invalid @enderror" >
                            ...
                            @foreach($designations as $designation)
                                <option value="{{$designation->id}}" {{old('designation')==$designation->id?'selected':''}}>{{$designation->designation}} - {{$designation->desg_description}}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('bankname')}}" id="bankname" name="bankname" class="form-control @error('bankname') is-invalid @enderror" placeholder="Bank Name" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('empaccno')}}" id="empaccno" name="empaccno" class="form-control @error('empaccno') is-invalid @enderror" placeholder="Account Number" >
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="center" id="center" class="form-control @error('center') is-invalid @enderror text-capitalize" >
                            ...
                            <option value="{{$center->id}}" {{old('center')==$center->id?'selected':''}}>{{$center->centername}}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('gpfno')}}" id="gpfno" name="gpfno" class="form-control" placeholder="GPF Number">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">NPS Number <span class="text-secondary">(optional)</span></label>
                        <input type="number" value="{{old('npsno')}}" id="npsno" name="npsno" class="form-control" placeholder="NPS Number">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="pf_nps_cat" id="pf_nps_cat" class="form-control @error('pf_nps_cat') is-invalid @enderror" >
                            <option value="">Select Category</option>
                            <option value="pf" {{old('pf_nps_cat')=="pf"?'selected':''}}>PF</option>
                            <option value="nps" {{old('pf_nps_cat')=="nps"?'selected':''}}>NPS</option>
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="prev_exp" id="prev_exp" class="form-control @error('prev_exp') is-invalid @enderror" >
                            ...
                            <option value="yes" {{old('prev_exp')=="yes"?'selected':''}}>Yes</option>
                            <option value="no" {{old('prev_exp')=="no"?'selected':''}}>No</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('prevorgname')}}" id="prevorgname" name="prevorgname" class="form-control @error('prevorgname') is-invalid @enderror" placeholder="Previous Organisation Name">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('totincomerec')}}" id="totincomerec" name="totincomerec" class="form-control" placeholder="Income Amount">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Total income tax recovered till DOJ <span class="text-secondary">(Optional)</span></label>
                        <input type="number" value="{{old('totincometax')}}" id="totincometax" name="totincometax" class="form-control" placeholder="Income Tax Amount">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Date of Medical Examination <span class="text-secondary">(Optional)</span></label>
                        <input type="date" value="{{old('domedicalexam')}}" id="domedicalexam" name="domedicalexam" class="form-control" placeholder="Date of Medical Examination">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('emppay')}}" id="emppay" name="emppay" class="form-control" placeholder="Pay" >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="form-label">Pay Scale <span class="text-secondary">(Optional)</span></label>
                        <input type="number" value="{{old('emppayscale')}}" id="emppayscale" name="emppayscale" class="form-control" placeholder="Pay Scale" >
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="payscallvl" id="payscallvl" class="form-control">
                            ...
                            @foreach($paylevels as $level)
                                <option value="{{$level->id}}" {{old('payscallvl')==$level->id? "selected":""}}>{{$level->paylevel}}</option>
                            @endforeach
                        </select>
                        <!-- <input type="number" value="{{old('payscallvl')}}" id="payscallvl" name="payscallvl" class="form-control" placeholder="Pay Scale Level"> -->
                    </div>
                </div>
            </div>
            <div class="text-right">
        ...
        <div class="section-4-form section-forms" style="display: none">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="quarters" id="quarters" class="form-control @error('quarters') is-invalid @enderror" >
                            <option value="">Select Yes/No</option>
                            <option value="yes" {{old('quarters')=="yes"?'selected':''}}>Yes</option>
                            <option value="no" {{old('quarters')=="no"?'selected':''}}>No</option>
                        </select>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('quartersno')}}" id="quartersno" name="quartersno" class="form-control @error('quartersno') is-invalid @enderror" placeholder="Quarters No">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{old('doccupied')}}" id="doccupied" name="doccupied" class="form-control @error('doccupied') is-invalid @enderror" placeholder="Date of Occupied">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{old('dovacated')}}" id="dovacated" name="dovacated" class="form-control" placeholder="Date of Vacated">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="eligiblehra" id="eligiblehra" class="form-control @error('eligiblehra') is-invalid @enderror" >
                            <option value="">Select Yes/No</option>
                            <option value="yes" {{old('eligiblehra')=="yes"?'selected':''}}>Yes</option>
                            <option value="no" {{old('eligiblehra')=="no"?'selected':''}}>No</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="handicap" id="handicap" class="form-control @error('handicap') is-invalid @enderror" >
                            <option value="">Select Yes/No</option>
                            <option value="yes" {{old('handicap')=="yes"?'selected':''}}>Yes</option>
                            <option value="no" {{old('handicap')=="no"?'selected':''}}>No</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="prnop" id="prnop" class="form-control @error('prnop') is-invalid @enderror" >
                            ...
                            <option value="pensioner" {{old('prnop')=="pensioner"?'selected':''}}>Pensioner</option>
                            <option value="nop" {{old('prnop')=="nop"?'selected':''}}>NOP</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group" id="pen_cat_div">
                        ...
                        <select name="pen_cat" id="pen_cat" class="form-control @error('pen_cat') is-invalid @enderror" >
                            <option value="">Select Category</option>
                            <option value="sp" {{old('pen_cat')=="sp"?'selected':''}}>Single Pensioner</option>
                            <option value="fp" {{old('pen_cat')=="fp"?'selected':''}}>Family Pensioner</option>
                        </select>
            ...
            <div class="text-right">
                <button class="btn btn-light mr-2 goBack" type="button">Go Back</button>
                <button class="btn btn-outline-dark saveBtn mr-2" type="button">Save</button>
                <button class="btn btn-primary saveNext">Submit</button>
            </div>
        </div>
    </form>
    ...
    <script>
        $(document).ready((e)=>{
            ...
            //for form errors
            let state = {{Js::from(old("empstate"))}}
            if(state!="" && state!=null){
                $("#empstate").change();
            }
            ...
            //get saved employee details to show
            if(sessionStorage.getItem("saved_employee_details")){
                const employeeDet = (JSON.parse(sessionStorage.getItem("saved_employee_details")));
                // Object.keys(employeeDet).forEach(key => {
                //     console.log(key, employeeDet[key]["name"]);
                // });
                employeeDet.forEach(det=>{
                    if(det.name!="_token"){
                        $("#"+det.name).val(det.value);
                        if(det.name=="empstate"){
                            $("#"+det.name).change();
                        }
                    }
                });
                // Object.entries(employeeDet).forEach((details) => {
